...
class TransaveNotifier {
    ...
    sendNotification() {
        ...
        if (theMTIClass == "04"){
            //enable sending for reversal transaction
            // return false
        }
        ...
        let username = process.env.TransaveUsername;
        let password = process.env.TransavePassword;
        let apiAuthorization = "Basic " + Buffer.from(username + ":" + password).toString("base64");
...
module.exports =   TransaveNotifier;
