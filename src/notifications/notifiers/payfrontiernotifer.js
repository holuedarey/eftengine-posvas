...
class PayFrontierNotifier {
    ...
    async sendNotification() {
        ...
        Util.fileDataLogger(this.notificationData.terminalId,`Sending out notification to ${this.notificationService.name}. Notification Body: ${notificationBody}`, JSON.stringify(notificationHeaders));
...
module.exports = PayFrontierNotifier;
