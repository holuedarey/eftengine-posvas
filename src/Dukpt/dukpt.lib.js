...
var Dukpt = function () {
    function Dukpt(bdk, ksn,keymode) {
    ...
    _createClass(Dukpt, [{
        ...
        value: function _deriveDukptSessionKey(keyMode = 'pinkey') {
            var keyMode = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'pinkey';
